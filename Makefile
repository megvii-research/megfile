...
test:
	pytest --cov-config=setup.cfg --cov=megfile --disable-socket --no-cov-on-fail --cov-report=html:html_cov/ --cov-report term-missing --cov-report=xml tests/test_cli.py --durations=10
