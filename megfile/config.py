...
if os.getenv('MEGFILE_MAX_BUFFER_SIZE'):
    DEFAULT_MAX_BUFFER_SIZE = int(os.getenv('MEGFILE_MAX_BUFFER_SIZE'))
    ...
    DEFAULT_BLOCK_CAPACITY = int(os.getenv('MEGFILE_BLOCK_CAPACITY'))
...
if os.getenv('MEGFILE_MAX_BLOCK_SIZE'):
    DEFAULT_MAX_BLOCK_SIZE = int(os.getenv('MEGFILE_MAX_BLOCK_SIZE'))
