...
def test_join_strs():
    assert FSPath('file://foo', 'some/path',
                  'bar') == FSPath('file://foo/some/path/bar')
...
def test_join_paths():
    assert FSPath(FSPath('file://foo'),
                  FSPath('bar')) == FSPath('file://foo/bar')
...
def test_operators():
    ...
    assert FSPath('file://foo') / 'bar' / 'baz' in {
...
def test_parents():
    ...
    assert tuple(FSPath(
        'foo',
        '../bar').parents) == (FSPath('foo/..'), FSPath('foo'), FSPath(''))

    assert tuple(FSPath('file://foo/bar').parents) == (
        FSPath('file://foo'), FSPath('file://'))
...
def test_joinpath():
    ...
    assert FSPath('file://foo').joinpath(
        FSPath('bar')) == FSPath('file://foo/bar')
    assert FSPath('file://foo').joinpath('bar',
                                         'baz') == FSPath('file://foo/bar/baz')
